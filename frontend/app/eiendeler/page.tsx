...
function AssetFormModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/40 z-50 flex items-end sm:items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-900 rounded-2xl w-full max-w-lg shadow-xl p-6 flex flex-col gap-4 max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between">
          <h2 className="font-semibold text-slate-900 dark:text-gray-100">{existing ? "Rediger eiendel" : "Ny eiendel"}</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3">
          <div>
            <label className="block text-xs font-medium text-slate-600 dark:text-gray-400 mb-1">Navn *</label>
          ...
          <div>
            <label className="block text-xs font-medium text-slate-600 dark:text-gray-400 mb-1">Kategori</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-medium text-slate-600 dark:text-gray-400 mb-1">Etasje</label>
              <input value={floor} onChange={(e) => setFloor(e.target.value)}
                className={inputCls}
                placeholder="f.eks. 2. etg." />
            </div>
            <div>
              <label className="block text-xs font-medium text-slate-600 dark:text-gray-400 mb-1">Rom</label>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label className="block text-xs font-medium text-slate-600 dark:text-gray-400 mb-1">Installasjonsdato</label>
              <input type="date" value={installDate} onChange={(e) => setInstallDate(e.target.value)}
                className={inputCls} />
            </div>
            <div>
              <label className="block text-xs font-medium text-slate-600 dark:text-gray-400 mb-1">Vedlikeholdsintervall (dager)</label>
          ...
          <div>
            <label className="block text-xs font-medium text-slate-600 dark:text-gray-400 mb-1">Siste vedlikehold</label>
    ...
    <AppShell>
      <div className="flex flex-col flex-1 overflow-auto">
        ...
        <div className="flex items-center justify-between px-6 py-4 bg-white dark:bg-gray-900 border-b border-slate-200 dark:border-gray-800 shrink-0">
          <h1 className="text-lg font-bold text-slate-900 dark:text-gray-100">Eiendeler</h1>
          <button
        ...
        <div className="flex-1 px-6 py-6">
          {loading ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {[0, 1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-2xl p-5 h-36 animate-pulse" />
              ))}
            </div>
          ) : filtered.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {filtered.map((asset) => {
                ...
                return (
                  <div key={asset.id}
                    className="bg-white dark:bg-gray-900 border border-slate-200 dark:border-gray-800 rounded-2xl p-5 flex flex-col gap-3 hover:shadow-sm hover:border-slate-300 dark:hover:border-gray-700 transition-all">
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <div className="flex gap-1 shrink-0">
                        <button
                          ...
                          className="p-1 rounded text-slate-400 dark:text-gray-500 hover:text-brand-600 dark:hover:text-brand-400 hover:bg-brand-50 dark:hover:bg-brand-900/20 transition-colors"
                        ...
                        <button
                          ...
                          className="p-1 rounded text-slate-400 dark:text-gray-500 hover:text-slate-700 dark:hover:text-gray-300 hover:bg-slate-100 dark:hover:bg-gray-800 transition-colors"
                          title="Rediger">
                          <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
                        ...
                        {confirmDelete === asset.id ? (
                          ...
                          <button onClick={() => setConfirmDelete(asset.id)}
                            className="p-1 rounded text-slate-400 dark:text-gray-500 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors" title="Slett">
                            <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
                    ...
                    <div>
                      <p className="font-semibold text-slate-800 dark:text-gray-200 text-sm leading-tight">{asset.name}</p>
                    ...
                    <div className="flex items-center justify-between mt-auto pt-2 border-t border-slate-100 dark:border-gray-800">
                      ...
                      {asset.maintenance_interval_days && (
                        <p className={`text-xs font-medium ${maint.overdue ? "text-red-600" : maint.urgent ? "text-orange-500" : "text-slate-400 dark:text-gray-500"}`}>
