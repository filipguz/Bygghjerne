    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="bg-slate-50 py-16 px-6">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold text-slate-900 mb-2 text-center">Fra PDF til svar</h2>
          <p className="text-slate-500 text-center mb-12 text-sm">Seks steg fra opplasting til presist svar</p>
            ...
            {steps.map((step) => (
              <div key={step.number} className="flex gap-5">
                ...
                <div className="pb-8 min-w-0">
                  ...
                  <p className="text-xs text-slate-400 bg-white border border-slate-100 rounded-lg px-3 py-2 inline-block">
                    {step.detail}
                  </p>
                </div>
              </div>
              ...
              <div key={s.name} className={`rounded-2xl border p-6 ${s.color}`}>
                <div className="flex items-start justify-between gap-2 mb-3">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 font-mono mt-0.5">{s.model}</p>
                  </div>
      ...
      <section className="bg-slate-50 py-16 px-6">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl font-bold text-slate-900 mb-2 text-center">Sikkerhet og personvern</h2>
          <p className="text-slate-500 text-center mb-10 text-sm">Dine dokumenter tilhører deg</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            <div className="flex flex-col gap-2">
              ...
              <h3 className="font-semibold text-slate-800 text-sm">Isolert per organisasjon</h3>
            ...
            <div className="flex flex-col gap-2">
              ...
              <h3 className="font-semibold text-slate-800 text-sm">Validert på hvert kall</h3>
              <p className="text-sm text-slate-500">
            ...
            <div className="flex flex-col gap-2">
              ...
              <h3 className="font-semibold text-slate-800 text-sm">Ikke brukt til AI-trening</h3>
              <p className="text-sm text-slate-500">
      ...
      <section className="py-20 px-6">
        <div className="max-w-2xl mx-auto text-center flex flex-col items-center gap-6">
          ...
          <div className="flex gap-3 flex-wrap justify-center">
            ...
            <Link
              href="/om-oss"
              className="inline-flex items-center gap-2 border border-slate-200 text-slate-700 px-7 py-3.5 rounded-xl text-sm font-semibold hover:bg-slate-50 transition-colors"
            >
              Les om oss
            </Link>
          </div>
